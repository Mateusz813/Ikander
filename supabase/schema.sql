...
create table if not exists public.rewards (
  ...
  consumed_at  timestamptz,                     -- wykupiona (nagroda jednorazowa)
  nego_price   int,                             -- aktualna propozycja ceny (negocjacja)
  nego_by      uuid references public.profiles(id), -- kto proponuje cenę
  created_at   timestamptz not null default now()
);
...
begin
  ...
  -- nagroda jednorazowa: konsumuj (oprócz domyślnej) i zamknij negocjację
...
-- negocjacja ceny (jak Vinted): propozycja + odpowiedź
